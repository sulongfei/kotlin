...
open class KotlinMPPGradleProjectResolver : AbstractProjectResolverExtensionCompat() {
    ...
    companion object {
        ...
        fun initializeModuleData(
            ...
            for (target in mppModel.targets) {
                ...
                for (compilation in target.compilations) {
                    ...
                    val internalName2 = getInternalModuleName2(gradleModule, externalProject, compilation.name, resolverCtx)

                    println(moduleInternalName + " " + internalName2)
        ...
        fun getInternalModuleName2(
            ...
            val moduleName = java.lang.StringBuilder()
